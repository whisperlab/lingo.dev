...
<p align="center">
  <strong>⚡️ AI-керований інструмент командного рядка з відкритим кодом для локалізації веб та мобільних додатків.</strong>
</p>
...
<p align="center">
  ...
  <a href="#">Поставити зірку репозиторію</a>
</p>
...
Ця дія запускає `lingo.dev i18n` при кожному push, автоматично підтримуючи ваші переклади в актуальному стані.

Для режиму запитів на злиття (pull request) та інших параметрів конфігурації відвідайте нашу [документацію GitHub Action](https://docs.lingo.dev/setup/gha).
